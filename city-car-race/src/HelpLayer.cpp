...
bool HelpLayer::init()
{
	...
	Sprite* bg = Sprite::create("help/MenuBg.png");
	...
	for(int i=0;i<4;i++)
	{
		spIntro[i] = Sprite::create(StringUtils::format("help/tu%d.png",i+1));
	...
	Sprite* kSprite = Sprite::create("help/kuang.png");
	...
	for(int i=0;i<7;i++)
	{
		if(i == currIntroIndex)
		{
			bSprite[i] = Sprite::create("help/white.png");
		}else
		{
			bSprite[i] = Sprite::create("help/blank.png");
		}
