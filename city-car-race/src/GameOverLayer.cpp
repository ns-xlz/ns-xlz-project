...
bool GameOverLayer::init()
{
	...
	gameOverBg = Sprite::create("pause/MenuBg.png");
	...
	{
		Sprite* pity = Sprite::create("LoseWin/Pity.png");
		pity->setPosition(Point(270,720));
		gameOverBg->addChild(pity,MENUZRODER);

		gameOverSprite[0] = Sprite::create("LoseWin/TryAgain.png");
		gameOverSprite[0]->setPosition(Point(270,340));
		gameOverBg->addChild(gameOverSprite[0],MENUZRODER);
	}else
	{
		Sprite* Congratulations = Sprite::create("LoseWin/Congratulations.png");
		Congratulations->setPosition(Point(270,720));
		gameOverBg->addChild(Congratulations,MENUZRODER);

		gameOverSprite[0] = Sprite::create("LoseWin/TryNext.png");
		gameOverSprite[0]->setPosition(Point(270,340));
		gameOverBg->addChild(gameOverSprite[0],MENUZRODER);
	}

	Sprite* Result = Sprite::create("LoseWin/Result.png");
	...
	LabelAtlas* lDistance = LabelAtlas::create(						//创建一个LabelAtlas对象
			StringUtils::format("%d",GameOverLayer::distance),"gamepic/upNum.png",20,23,'0');
	...
	LabelAtlas* lGold = LabelAtlas::create(						//创建一个LabelAtlas对象
			StringUtils::format("%d",GameOverLayer::gold),"gamepic/upNum.png",20,23,'0');
	...
	Sprite* jiaSprite = Sprite::create("LoseWin/jia.png");
	...
	gameOverSprite[1] = Sprite::create("mainpic/sp3.png");
	gameOverSprite[1]->setPosition(Point(270,260));
	gameOverBg->addChild(gameOverSprite[1],MENUZRODER);

	gameOverSprite[2] = Sprite::create("mainpic/sp2.png");
