...
void CityRacingSceneManager::goChooseCarLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,chooseCarscene);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
...
void CityRacingSceneManager::goMainLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,mainScene);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
void CityRacingSceneManager::goChooseLevelLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,levelScene);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
void CityRacingSceneManager::goShopLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,shopScene);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
void CityRacingSceneManager::goGameOverLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,gameOverSceen);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
void CityRacingSceneManager::goPHBLayer()
{
	...
	//创建一个切换场景到特效
	auto ss=TransitionFade::create(0.5,PHBScene);
	//切换到游戏场景
	Director::getInstance()->replaceScene(ss);
}
