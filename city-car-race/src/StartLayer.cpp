...
bool StartLayer::init()
{
	...
	//背景精灵
	Sprite* bgSprite = Sprite::create("mainpic/startbg.jpg");
	...
	MenuItemImage* phItem = MenuItemImage::create(
			   "mainpic/close.jpg",	//平时的图片
			   "mainpic/closep.jpg",	//选中时的图片
...
void StartLayer::initSound()
{
	CocosDenshion::SimpleAudioEngine::getInstance()
				->preloadBackgroundMusic("mainsound/background.mp3");
	...
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect(
														   "mainsound/daojishi.mp3"
														   );
	CocosDenshion::SimpleAudioEngine::getInstance()->preloadEffect(
														   "mainsound/start1.mp3"
														   );
...
void StartLayer::initMusicBT()
{
	...
	musicOnItem = MenuItemImage::create(
			   "mainpic/MusicOn.png",	//平时的图片
			   "mainpic/MusicOff.png",	//选中时的图片
	...
	musicOffItem = MenuItemImage::create(
			   "mainpic/MusicOff.png",	//平时的图片
			   "mainpic/MusicOn.png",	//选中时的图片
			   CC_CALLBACK_0(StartLayer::setMusicVisible, this) //点击时执行的回调方法
		);
	//设置下一个菜单项的位置
	...
	soundOnItem = MenuItemImage::create(
			   "mainpic/SoundOn.png",	//平时的图片
			   "mainpic/SoundOff.png",	//选中时的图片
	...
	soundOffItem = MenuItemImage::create(
			"mainpic/SoundOff.png",	//平时的图片
			"mainpic/SoundOn.png",	//选中时的图片
			CC_CALLBACK_0(StartLayer::setSoundVisible, this) //点击时执行的回调方法
		);
	//设置下一个菜单项的位置
